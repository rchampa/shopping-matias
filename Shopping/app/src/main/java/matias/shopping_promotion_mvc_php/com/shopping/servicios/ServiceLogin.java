...
import matias.shopping_promotion_mvc_php.com.shopping.LoginActivity;
import matias.shopping_promotion_mvc_php.com.shopping.tools.Post;
            ...
            try{
                ...
                if (datos != null && datos.length() > 0) {
                    ...
                    if (numRegistrados > 0) {
                        ...
                        // Aqu� se le puede pasar informaci�n al intent como el id del elemento o la posici�n con
                        // los m�todos putExtra
